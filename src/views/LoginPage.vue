<template>
  <DefaultLayout>
    <section v-if="currentAuthMethod === 'login'" class="bg-gray-50 dark:bg-gray-900">
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form @submit.prevent="login" class="space-y-4 md:space-y-6">
              ...
              <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                Don’t have an account yet? <a @click="currentAuthMethod = 'register'" href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
              </p>
            </form>
          </div>
        </div>
        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form @submit.prevent="login" class="space-y-4 md:space-y-6">
              ...
              <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                Already have an account? <a @click="currentAuthMethod = 'login'" href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign in</a>
              </p>
            </form>
          </div>
        </div>
...
export default {
  ...
  methods: {
    async login() {
      try {
        if(this.currentAuthMethod === 'login') {
